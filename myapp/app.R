...
ui <- fluidPage(
  ...
  navbarPage(title = "PhiLab.data/",
        tabPanel("The Dot Perspective Task",
            ...
            tags$p("Explore the DPT by selecting instances of the following important variables. For more information about these variables, please read below and review the related ", a(href = "https://osf.io/preprints/osf/zkgyt", "manuscript"), ". For more flexible analyses and additional information about this dataset, please visit this project's", a(href = "https://doi.org/10.7910/DVN/MBRXFK", "Dataverse Repository"), "."),
